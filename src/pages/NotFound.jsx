...
export default function NotFound() {
  return (
    <div className="container-x py-24 md:py-32 text-center">
      <p className="text-brand-300 font-semibold tracking-wider uppercase text-xs">404</p>
      <h1 className="mt-3 text-4xl md:text-5xl font-bold text-white">Page not found</h1>
